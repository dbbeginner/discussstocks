...
Route::get('verify/replace', '\App\Http\Controllers\Accounts\RequestNewActivationToken@create');
Route::post('verify/replace', '\App\Http\Controllers\Accounts\RequestNewActivationToken@store');
